	...
	<div id="settingsDialog" title="Settings" style="text-align:center">
		...
		?>
			...
			<div style="width:90%;margin:0 auto;text-align:left;max-height:180px;overflow-y:auto;background:rgba(255,255,255,0.1);padding:10px;border-radius:5px">
				<?php foreach(getSwedishCounties() as $county){?>
					<label style="display:block;color:white;font-weight:normal">
