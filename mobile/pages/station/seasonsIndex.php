...
<html>
	<head>
		<title><?php echo lang("seasons",'c')?></title>
		<?php metaHeader()?>
	...
	<body>
        ...
        <script>
            $(".statIcon").click(function(){
                ...
                if(id!="days"){
                    $("#seasonsDiv").load("<?php echo $pageURL.$path?>pages/station/seasons.php?var="+id);
                }
                else{
                    $("#seasonsDiv").load("<?php echo $pageURL.$path?>pages/station/seasonsDayNumber.php");
                }
            })
        </script>
	</body>
