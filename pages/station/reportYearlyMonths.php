			...
			<table id="mainTable2" class="table tableSpacing2Padding2">
				<tr>
					<th id="Topener2" style="text-align:center!important">
						<span class="mticon-temp imgHeader opener2 tooltip" title="<?php echo lang("temperature",'c')?>"></span>
					</th>
					<th id="Hopener2">
						<span class="mticon-humidity imgHeader opener2 tooltip" title="<?php echo lang("humidity",'c')?>"></span>
					</th>
					<th id="Popener2">
						<span class="mticon-pressure imgHeader opener2 tooltip" title="<?php echo lang("pressure",'c')?>"></span>
					</th>
					<th id="Wopener2">
						<span class="mticon-wind imgHeader opener2 tooltip" title="<?php echo lang("wind speed",'c')?>"></span>
					</th>
					<th id="Gopener2">
						<span class="mticon-gust imgHeader opener2 tooltip" title="<?php echo lang("wind gust",'c')?>"></span>
					</th>
					<th id="Dopener2">
						<span class="mticon-dewpoint imgHeader opener2 tooltip" title="<?php echo lang("dew point",'c')?>"></span>
					</th>
					<th id="Aopener2">
						<span class="mticon-apparent imgHeader opener2 tooltip" title="<?php echo lang("apparent temperature",'c')?>"></span>
					</th>
					<th id="Ropener2">
						<span class="mticon-rain imgHeader opener2 tooltip" title="<?php echo lang("precipitation",'c')?>"></span>
					</th>
					<?php
						if($solarSensor){
					?>
						<th id="opener2">
							<span class="mticon-sun imgHeader opener2 tooltip" title="<?php echo lang("solar radiation",'c')?>"></span>
						</th>
					<?php
						}
					?>
					...
					<thead>
						<tr>
							...
							<th class="summaryTableHeading">
								<?php echo lang("station",'c')." ".lang("average",'l')?><br><span class="fa fa-unsorted sort"></span>
							</th>
							<th class="summaryTableHeading">
								<?php echo lang("deviation",'c')?><br><span class="fa fa-unsorted sort"></span>
							</th>
						</tr>
					</thead>
					<tbody>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<?php echo number_format($data['monthlyclass="sort2"H'][$i]-$data['monthlyMinH'][$i],1,".","")?>
								</td>
						...
						?>
							<tr>
								...
								<td style="font-weight:bold;color:white;background:<?php echo fill($data['monthlyAvgP'][$i],array((min($data['monthlyAvgP'])-0.001),(max($data['monthlyAvgP'])+0.001)),array("#FFC926", "#c926ff"))?>">
									<?php echo number_format(convertP($data['monthlyAvgP'][$i]),$decimalsP+1,".","")?>
								</td>
								<td style="font-weight:bold;color:white;background:<?php echo fill($data['monthlyMaxP'][$i],array((min($data['monthlyMaxP'])-0.001),(max($data['monthlyMaxP'])+0.001)),array("#FFC926", "#c926ff"))?>">
									<?php echo number_format(convertP($data['monthlyMaxP'][$i]),$decimalsP,".","")?>
								</td>
								<td style="font-weight:bold;color:white;background:<?php echo fill($data['monthlyMinP'][$i],array((min($data['monthlyMinP'])-0.001),(max($data['monthlyMinP'])+0.001)),array("#FFC926", "#c926ff"))?>">
									<?php echo number_format(convertP($data['monthlyMinP'][$i]),$decimalsP,".","")?>
								</td>
								<td>
									<?php echo number_format(convertP($data['monthlyMaxP'][$i])-convertP($data['monthlyMinP'][$i]),$decimalsP,".","")?>
								</td>
								<td style="font-weight:bold;color:white;background:<?php echo fill($stationAverageP[$i],array((min($stationAverageP)-0.001),(max($stationAverageP)+0.001)),array("#FFC926", "#c926ff"))?>">
									<?php echo number_format($stationAverageP[$i],$decimalsP+1,".","")?>
								</td>
								<?php
									if($deviationsP[$i]<0){
					...
					<thead>
						<tr>
							...
							<th>
								...
								<br>
								<span class="fa fa-unsorted sort"></span>
							</th>
						</tr>
					</thead>
					<tbody>
						...
						?>
							<tr>
								...
								<td style="font-weight:bold;color:black;background:<?php echo fill($data['monthlyR'][($i)],array((min($data['monthlyR'])-0.001),(max($data['monthlyR'])+0.001)),array("#FFFFFF", "#00BFFF"))?>">
									<?php echo number_format(convertR($data['monthlyR'][($i)]),2,".","")?>
								</td>
							</tr>
						<?php
							}
