	...
	if(file_exists("cache/monthly".$chosenYear."_".$chosenMonth.".txt")){
		...
		while($row = mysqli_fetch_array($result)){
			...
			if($row['H']==$data['monthlyMinH']){
				$date_temporary = strtotime($row['DateTime']);
				array_push($data['monthlyMinHDate'],date($timeFormat." ".$dateFormat, $date_temporary));
			}
	...
	<div id="overview" class="content" id="basicSummary">
		<table class="table">
			...
			<tr>
				...
				<td class="value cellSecond">
					<?php echo number_format(convertT($data['highestTHourValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				...
				<td class="value">
					<?php echo number_format(convertT($data['highestTHourValueAbs']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['lowestTHourValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['lowestTHourValueAbs']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['highestTDayValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['lowestTDayValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
		</table>
		<table class="table">
			...
			<tr>
				...
				<td class="value cellSecond">
					<?php echo number_format(convertT($data['highestAHourValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['highestAHourValueAbs']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['lowestAHourValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['lowestAHourValueAbs']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['highestADayValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['lowestADayValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
		</table>
		<table class="table">
			...
			<tr>
				...
				<td class="value cellSecond">
					<?php echo number_format(convertT($data['highestDHourValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['highestDHourValueAbs']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['lowestDHourValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['lowestDHourValueAbs']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['highestDDayValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertT($data['lowestDDayValue']),$decimalT,'.','')." ".unitFormatter($displayTempUnits)?>
				</td>
			</tr>
		</table>
		<table class="table">
			...
			<tr>
				...
				<td class="value cellSecond">
					<?php echo number_format($data['highestHHourValue'],$decimalH,'.','')." %"?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format($data['highestHHourValueAbs'],$decimalH,'.','')." %"?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format($data['lowestHHourValue'],$decimalH,'.','')." %"?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format($data['lowestHHourValueAbs'],$decimalH,'.','')." %"?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format($data['highestHDayValue'],$decimalH,'.','')." %"?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format($data['lowestHDayValue'],$decimalH,'.','')." %"?>
				</td>
			</tr>
		</table>
		<table class="table">
			...
			<tr>
				...
				<td class="value cellSecond">
					<?php echo number_format(convertP($data['highestPHourValue']),$decimalP,'.','')." ".unitFormatter($displayPressUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertP($data['highestPHourValueAbs']),$decimalP,'.','')." ".unitFormatter($displayPressUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertP($data['lowestPHourValue']),$decimalP,'.','')." ".unitFormatter($displayPressUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertP($data['lowestPHourValueAbs']),$decimalP,'.','')." ".unitFormatter($displayPressUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertP($data['highestPDayValue']),$decimalP,'.','')." ".unitFormatter($displayPressUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertP($data['lowestPDayValue']),$decimalP,'.','')." ".unitFormatter($displayPressUnits)?>
				</td>
			</tr>
		</table>
		<table class="table">
			...
			<tr>
				...
				<td class="value cellSecond">
					<?php echo number_format(convertW($data['highestWHourValue']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['highestWHourValueAbs']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['lowestWHourValue']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['lowestWHourValueAbs']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['highestWDayValue']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['lowestWDayValue']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
		</table>
		<table class="table">
			...
			<tr>
				...
				<td class="value cellSecond">
					<?php echo number_format(convertW($data['highestGHourValue']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['highestGHourValueAbs']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['lowestGHourValue']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['lowestGHourValueAbs']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['highestGDayValue']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
			<tr>
				<th style="text-align:left">
				...
				<td class="value">
					<?php echo number_format(convertW($data['lowestGDayValue']),$decimalW,'.','')." ".unitFormatter($displayWindUnits)?>
				</td>
			</tr>
		</table>
		<?php
		...
		?>
			<table class="table">
				...
				<tr>
					...
					<td class="value cellSecond">
						<?php echo number_format($data['highestSHourValue'],$decimalS,'.','')." W/m<sup>2</sup>"?>
					</td>
				</tr>
				<tr>
					<th style="text-align:left">
					...
					<td class="value">
						<?php echo number_format($data['highestSHourValueAbs'],$decimalS,'.','')." W/m<sup>2</sup>"?>
					</td>
				</tr>
				<tr>
					<th style="text-align:left">
					...
					<td class="value">
						<?php echo number_format($data['highestSDayValue'],$decimalS,'.','')." W/m<sup>2</sup>"?>
					</td>
				</tr>
			</table>
		<?php
		...
		<table class="table">
			...
			<tr>
				...
				<td class="cellSecond">
					<?php echo number_format(convertR($data['highestRDayValue']),$decimalR)." ".$displayRainUnits?>
				</td>
				<td class="value cellSecond">
