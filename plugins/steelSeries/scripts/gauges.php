...
function () {
    ...
    */
    ...
    function createSummary(data){
        $("#currentT").html("<span class='actualValue'>" + data['temp'] + " <?php echo unitFormatter($displayTempUnits)?></span>");
        $("#todayMaxT").html("<span class='actualValue'>" + data['tempTH'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['TtempTH'] + "</span>");
        $("#todayMinT").html("<span class='actualValue'>" + data['tempTL'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['TtempTL'] + "</span>");
        $("#yesterdayMaxT").html("<span class='actualValue'>" + data['yesterday']['data']['maxT'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['maxTTime'] + "</span>");
        $("#yesterdayMinT").html("<span class='actualValue'>" + data['yesterday']['data']['minT'] + "<?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['minTTime'] + "</span>");

        $("#currentA").html("<span class='actualValue'>" + data['apptemp'] + " <?php echo unitFormatter($displayTempUnits)?></span>");
        $("#todayMaxA").html("<span class='actualValue'>" + data['apptempTH'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['TapptempTH'] + "</span>");
        $("#todayMinA").html("<span class='actualValue'>" + data['apptempTL'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['TapptempTL'] + "</span>");
        $("#yesterdayMaxA").html("<span class='actualValue'>" + data['yesterday']['data']['maxA'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['maxATime'] + "</span>");
        $("#yesterdayMinA").html("<span class='actualValue'>" + data['yesterday']['data']['minA'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['minATime'] + "</span>");

        $("#currentD").html("<span class='actualValue'>" + data['dew'] + " <?php echo unitFormatter($displayTempUnits)?></span>");
        $("#todayMaxD").html("<span class='actualValue'>" + data['dewpointTH'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['TdewpointTH'] + "</span>");
        $("#todayMinD").html("<span class='actualValue'>" + data['dewpointTL'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['TdewpointTL'] + "</span>");
        $("#yesterdayMaxD").html("<span class='actualValue'>" + data['yesterday']['data']['maxD'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['maxDTime'] + "</span>");
        $("#yesterdayMinD").html("<span class='actualValue'>" + data['yesterday']['data']['minD'] + " <?php echo unitFormatter($displayTempUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['minDTime'] + "</span>");

        $("#currentH").html("<span class='actualValue'>" + data['hum'] + " %</span>");
        $("#todayMaxH").html("<span class='actualValue'>" + data['humTH'] + " %</span><br><span class='timeValue'>" + data['ThumTH'] + "</span>");
        $("#todayMinH").html("<span class='actualValue'>" + data['humTL'] + " %</span><br><span class='timeValue'>" + data['ThumTL'] + "</span>");
        $("#yesterdayMaxH").html("<span class='actualValue'>" + data['yesterday']['data']['maxH'] + " %</span><br><span class='timeValue'>" + data['yesterday']['data']['maxHTime'] + "</span>");
        $("#yesterdayMinH").html("<span class='actualValue'>" + data['yesterday']['data']['minH'] + " %</span><br><span class='timeValue'>" + data['yesterday']['data']['minHTime'] + "</span>");

        $("#currentP").html("<span class='actualValue'>" + data['press'] + " <?php echo unitFormatter($displayPressUnits)?></span>");
        $("#todayMaxP").html("<span class='actualValue'>" + data['pressTH'] + " <?php echo unitFormatter($displayPressUnits)?></span><br><span class='timeValue'>" + data['TpressTH'] + "</span>");
        $("#todayMinP").html("<span class='actualValue'>" + data['pressTL'] + " <?php echo unitFormatter($displayPressUnits)?></span><br><span class='timeValue'>" + data['TpressTL'] + "</span>");
        $("#yesterdayMaxP").html("<span class='actualValue'>" + data['yesterday']['data']['maxP'] + " <?php echo unitFormatter($displayPressUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['maxPTime'] + "</span>");
        $("#yesterdayMinP").html("<span class='actualValue'>" + data['yesterday']['data']['minP'] + " <?php echo unitFormatter($displayPressUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['minPTime'] + "</span>");

        $("#currentW").html("<span class='actualValue'>" + data['wlatest'] + " <?php echo unitFormatter($displayWindUnits)?></span>");
        $("#todayMaxW").html("<span class='actualValue'>" + data['windTM'] + " <?php echo unitFormatter($displayWindUnits)?></span><br><span class='timeValue'>" + data['TwindTM'] + "</span>");
        $("#yesterdayMaxW").html("<span class='actualValue'>" + data['yesterday']['data']['maxW'] + " <?php echo unitFormatter($displayWindUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['maxWTime'] + "</span>");

        $("#currentG").html("<span class='actualValue'>" + data['wgust'] + " <?php echo unitFormatter($displayWindUnits)?></span>");
        $("#todayMaxG").html("<span class='actualValue'>" + data['wgustTM'] + " <?php echo unitFormatter($displayWindUnits)?></span><br><span class='timeValue'>" + data['TwgustTM'] + "</span>");
        $("#yesterdayMaxG").html("<span class='actualValue'>" + data['yesterday']['data']['maxG'] + " <?php echo unitFormatter($displayWindUnits)?></span><br><span class='timeValue'>" + data['yesterday']['data']['maxGTime'] + "</span>");

        $("#todayR").html("<span class='actualValue'>" + data['rfall'] + " <?php echo unitFormatter($displayRainUnits)?></span>");
        $("#yesterdayR").html("<span class='actualValue'>" + data['yesterday']['data']['R'] + " <?php echo unitFormatter($displayRainUnits)?></span>");

        <?php
            if($solarSensor){
        ?>
                $("#currentS").html("<span class='actualValue'>" + data['SolarRad'] + " W/m2</span>");
                $("#todayMaxS").html("<span class='actualValue'>" + data['SolarTM'] + " W/m2</span><br><span class='timeValue'>" + data['TSolarTM'] + "</span>");
                $("#yesterdayMaxS").html("<span class='actualValue'>" + data['yesterday']['data']['maxS'] + " W/m2</span><br><span class='timeValue'>" + data['yesterday']['data']['maxSTime'] + "</span>");
        <?php
            }
        ?>
    }
