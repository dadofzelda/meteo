			...
			<table style="width:98%;margin: 0 auto;position:absolute;top:5px;z-index:10">
				<tr>
					<td style="text-align:left" colspan="">
						<img src="<?php echo $pageURL.$path?>icons/freezingLine.png" id="negativeColorSwitcher" onclick="colorNegative()" alt="" class="tooltip" title="<?php echo lang('highlight negative','c')?>">
					</td>
				</tr>
			</table>
			<div style="width:100%;text-align:center;position:absolute;top:50;left:0;z-index:10">
				<img id="spinner" class="mtSpinner" style="width:100px;padding-top:200px" src="<?php echo $pageURL.$path?>icons/logo.png">
			</div>
			<div id="graph" style="min-width: 400px; height: 98%; margin: 0 auto;z-index:5">
			</div>
		</div>
		<br>
		<input type="hidden" id="chosenParameter" value="<?php echo $var ?>">
		...
		<table style="margin-left:auto;margin-right:auto">
			<tr>
				<td style="border-left:2px solid #<?php echo $color_schemes[$design]['400']?>">
					<span class="calendar tooltip" id="valuesAll" onclick="valueSet('all')" title="<?php echo lang("all",'c')?>" style="opacity:1">
						<?php echo strtoupper(lang("all",'c'))?>
					</span>
				</td>
				<td>
					<img src="<?php echo $pageURL.$path?>icons/calendar_hour.png" class="calendar tooltip" id="valuesHour" onclick="valueSet('h')" title="<?php echo lang("hourly averages",'c')?>" alt=''>
				</td>
				<td>
					<img src="<?php echo $pageURL.$path?>icons/calendar_day.png" class="calendar tooltip" id="valuesDay" onclick="valueSet('d')" title="<?php echo lang("daily averages",'c')?>" alt=''>
				</td>
				<td>
					<img src="<?php echo $pageURL.$path?>icons/calendar_month.png" class="calendar tooltip" id="valuesMonth" onclick="valueSet('m')" title="<?php echo lang("monthly averages",'c')?>" alt=''>
				</td>
