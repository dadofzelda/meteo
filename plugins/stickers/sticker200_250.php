<?php
	...
	textCenter($png_image,($width/2 + 3), 53, $text, 4, 11, $black, 0);
	textCenter($png_image,($width/2), 50, $text, 4, 11, $color2, 0);
	
	textCenter($png_image,($width/2 + 3), 91, $T." °".$displayTempUnits, 6, 18, $black, 0);  
	textCenter($png_image,($width/2 + 3), 90, $T." °".$displayTempUnits, 6, 18, $color2, 0);
	
	textCenter($png_image,($width/2 + 3), 121, $H." %", 6, 18, $black, 0);  
	textCenter($png_image,($width/2 + 3), 120, $H." %", 6, 18, $color2, 0);
	
	textCenter($png_image,($width/2 + 3), 151, $P." ".$displayPressUnits, 6, 18, $black, 0);  
	textCenter($png_image,($width/2 + 3), 150, $P." ".$displayPressUnits, 6, 18, $color2, 0);
	
	textCenter($png_image,($width/2 + 3), 181, $W." ".$displayWindUnits, 6, 18, $black, 0);  
	textCenter($png_image,($width/2 + 3), 180, $W." ".$displayWindUnits, 6, 18, $color2, 0);
	
	textCenter($png_image,($width/2 + 3), 211, $R." ".$displayRainUnits, 6, 18, $black, 0);  
	textCenter($png_image,($width/2 + 3), 210, $R." ".$displayRainUnits, 6, 18, $color2, 0);
