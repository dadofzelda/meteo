<?php
	...
	echo "<span style='color:red'>Errors will be highlighted in red, blank lines may also show as errors.</span><br><br>";
	...
	echo "<br>";
	echo "<hr>";
	echo" <br>After import of each day, this date will be inserted to the cache file. Make sure you check this file to see what has been imported in case the script times out!<br>";
	...
	while($current<=$to){
		...
		// create cache file
		file_put_contents("wuImportCache.txt",date("Y-m-d",$current));
	}
	//echo "<br><br>--- END ----";
