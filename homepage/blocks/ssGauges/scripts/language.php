...
LANG.EN = {
    ...
    //
    temp_title_out    : '<?php echo lang("temperature","c")?>',
    temp_title_in     : '<?php echo lang("indoor temperature","c")?>',
    temp_out_info     : '<?php echo lang("temperature","c")?>',
    temp_out_web      : 'Outside',
    temp_in_info      : '<?php echo lang("indoor temperature","c")?>',
    temp_in_web       : 'Inside',
    temp_trend_info   : '<?php echo lang("temperature trend","c")?>',
    //
    dew_title         : '<?php echo lang("dew point","c")?>',
    dew_info          : '<?php echo lang("dew point","c")?>',
    dew_web           : '<?php echo lang("dew point","c")?>',
    apptemp_title     : '<?php echo lang("apparent temperature","c")?>',
    apptemp_info      : '<?php echo lang("apparent temperature","c")?>',
    apptemp_web       : '<?php echo lang("apparent temperature","c")?>',
    ...
    humdx_web         : 'Humidex',
    //
    rain_title        : '<?php echo lang("precipitation","c")?>',
    rrate_title       : '<?php echo lang("rain rate","c")?>',
    rrate_info        : '<?php echo lang("rain rate","c")?>',
    LastRain_info     : '<?php echo lang("precipitation","c")?>',
    LastRainedT_info  : '<?php echo lang("today","c")?>',
    LastRainedY_info  : '<?php echo lang("yesterday","c")?>',
    //
    hum_title_out     : '<?php echo lang("humidity","c")?>',
    hum_title_in      : 'Inside Hum',
    hum_out_info      : '<?php echo lang("humidity","c")?>',
    hum_in_info       : 'Inside Humidity',
    hum_out_web       : 'Outside',
    hum_in_web        : 'Inside',
    //
    baro_title        : '<?php echo lang("pressure","c")?>',
    baro_info         : '<?php echo lang("pressure","c")?>',
    baro_trend_info   : '<?php echo lang("pressure trend","c")?>',
    //
    wind_title        : '<?php echo lang("wind speed","c")?>',
    tenminavg_title   : '<?php echo lang("average","c")." ".lang('wind speed','l')?>',
    tenminavgwind_info: '<?php echo lang("average","c")." ".lang('wind speed','l')?> (<?php echo lang('today','l')?>)',
    maxavgwind_info   : '<?php echo lang('maximumAbbr','c')." ".lang("average","l")." ".lang('wind speed','l')?>',
    tenmingust_info   : '<?php echo lang("wind gust","c")?>',
    maxgust_info      : '<?php echo lang("maximumAbbr","c")." ".lang('wind gust','l')?> (<?php echo lang('today','l')?>)',
    latest_title      : '<?php echo lang("wind speed","c")?>',
    latestwind_info   : '<?php echo lang("wind speed","c")?>',
    bearing_info      : '<?php echo lang("wind direction","c")?>',
    latest_web        : '<?php echo lang("current","c")?>',
    tenminavg_web     : '<?php echo lang("average","c")?>',
    dominant_bearing  : '<?php echo lang("prevailing wind","c")?>',
    calm              : '<?php echo lang("calm","c")?>',
    windrose          : '<?php echo lang("wind rose","c")?>',
    windruntoday      : '<?php echo lang("wind run","c")." ".lang('today','l')?>',
    //
    uv_title          : 'UV',
    uv_levels         : ['<?php echo lang("none","c")?>',
                         '<?php echo lang("no danger","c")?>',
    ...
    //
    solar_title          : '<?php echo lang("solar radiation","c")?>',
    solar_currentMax     : '',
    solar_ofMax          : 'of maximum',
    solar_maxToday       : '<?php echo lang("maximumAbbr","c")." ".lang('today','l')?>',
    //
    ...
    metres            : 'm',
    //
    lowest_info       : '<?php echo lang("lowest","c")?>',
    highest_info      : '<?php echo lang("highest","c")?>',
    lowestF_info      : '<?php echo lang("lowest","c")?>',     // for proper translation of feminine words
    highestF_info     : '<?php echo lang("highest","c")?>',    // for proper translation of feminine words
    //
    RisingVeryRapidly : '<?php echo lang("rising very rapidly","c")?>',
    RisingQuickly     : '<?php echo lang("rising quickly","c")?>',
    Rising            : '<?php echo lang("rising","c")?>',
    RisingSlowly      : '<?php echo lang("rising slowly","c")?>',
    Steady            : '<?php echo lang("steady","c")?>',
    FallingSlowly     : '<?php echo lang("falling slowly","c")?>',
    Falling           : '<?php echo lang("falling","c")?>',
    FallingQuickly    : '<?php echo lang("falling quickly","c")?>',
    FallingVeryRapidly: '<?php echo lang("falling very rapidly","c")?>',
    //
    maximum_info      : '<?php echo lang("maximum","c")?>',
    max_hour_info     : '<?php echo lang("maximumAbbr","c")."/".lang('hAbbr','l')?>',
    minimum_info      : '<?php echo lang("minimum","c")?>',
    //
    coords            : ['<?php echo lang("directionN","u")?>', '<?php echo lang("directionNNE","u")?>', '<?php echo lang("directionNE","u")?>', '<?php echo lang("directionENE","u")?>', '<?php echo lang("directionE","u")?>', '<?php echo lang("directionESE","u")?>', '<?php echo lang("directionSE","u")?>', '<?php echo lang("directionSSE","u")?>', '<?php echo lang("directionS","u")?>', '<?php echo lang("directionSSW","u")?>', '<?php echo lang("directionSW","u")?>', '<?php echo lang("directionWSW","u")?>', '<?php echo lang("directionW","u")?>', '<?php echo lang("directionWNW","u")?>', '<?php echo lang("directionNW","u")?>', '<?php echo lang("directionNNW","u")?>'],
    compass           : ['<?php echo lang("directionN","u")?>', '<?php echo lang("directionNE","u")?>', '<?php echo lang("directionE","u")?>', '<?php echo lang("directionSE","u")?>', '<?php echo lang("directionS","u")?>', '<?php echo lang("directionSW","u")?>', '<?php echo lang("directionW","u")?>', '<?php echo lang("directionNW","u")?>'],
    months            : ['<?php echo lang("month1short","c")?>', '<?php echo lang("month2short","c")?>', '<?php echo lang("month3short","c")?>', '<?php echo lang("month4short","c")?>', '<?php echo lang("month5short","c")?>', '<?php echo lang("month6short","c")?>', '<?php echo lang("month7short","c")?>', '<?php echo lang("month8short","c")?>', '<?php echo lang("month9short","c")?>', '<?php echo lang("month10short","c")?>', '<?php echo lang("month11short","c")?>', '<?php echo lang("month12short","c")?>']
};
